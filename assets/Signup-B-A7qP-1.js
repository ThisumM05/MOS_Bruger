import{v as Xe,r as R,al as Ae,a as Te,u as Ie,o as Pe,j as n,am as Ne,an as Ue,ao as qe,ap as we,aq as Se,ar as ke,as as Me,at as Ce,au as De,av as Fe,aw as ze,ax as Oe}from"./index-CGlbydsB.js";const Ee=()=>{const e=Xe.c(115),[h,_e]=R.useState(!1),f=Ae(),t=Te(),c=Ie(),{loading:o,error:u,isAuthenticated:m,user:p}=Pe($e);let X;e[0]===Symbol.for("react.memo_cache_sentinel")?(X={email:"",password:"",role:"CUSTOMER"},e[0]=X):X=e[0];const[a,Le]=R.useState(X);let A;e[1]===Symbol.for("react.memo_cache_sentinel")?(A={username:"",email:"",password:""},e[1]=A):A=e[1];const[s,Re]=R.useState(A);let T;e[2]!==t||e[3]!==f.pathname?(T=()=>{f.pathname==="/signup"&&_e(!0),t(Ne())},e[2]=t,e[3]=f.pathname,e[4]=T):T=e[4];let I;e[5]!==t||e[6]!==f?(I=[f,t],e[5]=t,e[6]=f,e[7]=I):I=e[7],R.useEffect(T,I);let P;e[8]!==m||e[9]!==c||e[10]!==p?.role?(P=()=>{m&&(p?.role==="STAFF"||p?.role==="ADMIN"?c("/staff-dashboard"):c("/"))},e[8]=m,e[9]=c,e[10]=p?.role,e[11]=P):P=e[11];let U;e[12]!==m||e[13]!==c||e[14]!==p?(U=[m,p,c],e[12]=m,e[13]=c,e[14]=p,e[15]=U):U=e[15],R.useEffect(P,U);let q;e[16]!==t?(q=r=>{t(Ne()),_e(r)},e[16]=t,e[17]=q):q=e[17];const d=q;let M;e[18]!==a?(M=r=>Le({...a,[r.target.name]:r.target.value}),e[18]=a,e[19]=M):M=e[19];const i=M;let O;e[20]!==s?(O=r=>Re({...s,[r.target.name]:r.target.value}),e[20]=s,e[21]=O):O=e[21];const l=O;let $;e[22]!==t||e[23]!==a?($=r=>{r.preventDefault(),t(Ue(a))},e[22]=t,e[23]=a,e[24]=$):$=e[24];const xe=$;let G;e[25]!==t||e[26]!==s?(G=r=>{r.preventDefault(),t(qe(s))},e[25]=t,e[26]=s,e[27]=G):G=e[27];const be=G;let B;e[28]===Symbol.for("react.memo_cache_sentinel")?(B=n.jsx("style",{children:`
        .auth-page-wrapper {
          display: flex;
