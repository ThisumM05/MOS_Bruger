import{y as Re,r as L,ax as Xe,a as Ie,u as Te,b as Pe,j as t,ay as Ne,az as Ue,aA as Me,aB as we,aC as Se,aD as ke,aE as Oe,aF as Ce,aG as De,aH as Fe,aI as ze,aJ as qe}from"./index-BoiHWnoX.js";const Ee=()=>{const e=Re.c(115),[h,_e]=L.useState(!1),f=Xe(),a=Ie(),c=Te(),{loading:o,error:u,isAuthenticated:m,user:p}=Pe($e);let R;e[0]===Symbol.for("react.memo_cache_sentinel")?(R={email:"",password:"",role:"CUSTOMER"},e[0]=R):R=e[0];const[n,Ae]=L.useState(R);let X;e[1]===Symbol.for("react.memo_cache_sentinel")?(X={username:"",email:"",password:""},e[1]=X):X=e[1];const[s,Le]=L.useState(X);let I;e[2]!==a||e[3]!==f.pathname?(I=()=>{f.pathname==="/signup"&&_e(!0),a(Ne())},e[2]=a,e[3]=f.pathname,e[4]=I):I=e[4];let T;e[5]!==a||e[6]!==f?(T=[f,a],e[5]=a,e[6]=f,e[7]=T):T=e[7],L.useEffect(I,T);let P;e[8]!==m||e[9]!==c||e[10]!==p?.role?(P=()=>{m&&(p?.role==="STAFF"?c("/staff-dashboard"):p?.role==="ADMIN"?c("/admin-dashboard"):c("/"))},e[8]=m,e[9]=c,e[10]=p?.role,e[11]=P):P=e[11];let U;e[12]!==m||e[13]!==c||e[14]!==p?(U=[m,p,c],e[12]=m,e[13]=c,e[14]=p,e[15]=U):U=e[15],L.useEffect(P,U);let M;e[16]!==a?(M=r=>{a(Ne()),_e(r)},e[16]=a,e[17]=M):M=e[17];const d=M;let O;e[18]!==n?(O=r=>Ae({...n,[r.target.name]:r.target.value}),e[18]=n,e[19]=O):O=e[19];const i=O;let q;e[20]!==s?(q=r=>Le({...s,[r.target.name]:r.target.value}),e[20]=s,e[21]=q):q=e[21];const l=q;let $;e[22]!==a||e[23]!==n?($=r=>{r.preventDefault(),a(Ue(n))},e[22]=a,e[23]=n,e[24]=$):$=e[24];const xe=$;let G;e[25]!==a||e[26]!==s?(G=r=>{r.preventDefault(),a(Me(s))},e[25]=a,e[26]=s,e[27]=G):G=e[27];const be=G;let B;e[28]===Symbol.for("react.memo_cache_sentinel")?(B=t.jsx("style",{children:`
        .auth-page-wrapper {
          display: flex;
